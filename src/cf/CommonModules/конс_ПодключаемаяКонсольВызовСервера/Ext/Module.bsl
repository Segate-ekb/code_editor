...
Процедура ИнициализироватьРедактор(Форма, УникальныйИдентификатор, Версия = "1.0") Экспорт
	...
	Форма.конс_ВерсияОбработки = Версия;
	...
	Если ДанныеМакета <> Неопределено Тогда
		Форма.конс_АдресМакета = ПоместитьВоВременноеХранилище(ДанныеМакета, УникальныйИдентификатор);
	КонецЕсли;
	
	// Получаем коллекцию общих модулей
	КоллекцияОбщихМодулей = конс_ПодключаемаяКонсольСервер.ПолучитьКоллекциюОбщихМодулей();
	Форма.конс_АдресОбщихМодулей = ПоместитьВоВременноеХранилище(КоллекцияОбщихМодулей, УникальныйИдентификатор);
...
Функция ПолучитьРеквизитыФормыРедактора() Экспорт
	...
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_HTML", ТипСтрока, ""));
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_АдресМакета", ТипСтрока, ""));
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_АдресОбщихМодулей", ТипСтрока, ""));
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_ВерсияОбработки", ТипСтрока, "1.0"));
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_АдресХраненияПеременных", ТипСтрока, ""));
	
	// Числовые реквизиты
	ТипЧисло = Новый ОписаниеТипов("Число");
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_РежимПоказаПеременных", ТипЧисло, 1));
	
	// Булевы реквизиты
	ТипБулево = Новый ОписаниеТипов("Булево");
	Реквизиты.Добавить(Новый Структура("Имя, Тип, Значение", "конс_ИсходникиЗагружены", ТипБулево, Ложь));
...
//   РежимПоказаПеременных - Число - режим (0/1/2)
//
// Возвращаемое значение:
