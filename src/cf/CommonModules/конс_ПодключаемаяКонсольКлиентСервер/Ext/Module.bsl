...
// Извлекает номер оригинальной строки из маркера //@@N в инлайн-коде.
// Инлайнер добавляет маркер //@@N в конец каждой строки, где N - номер строки в оригинальном коде.
// 
// Параметры:
//   ТекстКода - Строка - полный текст инлайн-кода (с маркерами //@@N)
//   НомерСтроки - Число - номер строки в инлайн-коде (нумерация с 1)
//
// Возвращаемое значение:
//   Число - номер строки в оригинальном коде, или НомерСтроки если маркер не найден
//
Функция ИзвлечьОригинальнуюСтроку(ТекстКода, НомерСтроки) Экспорт
	
	Возврат конс_Инлайнер.ПолучитьОригинальнуюСтроку(ТекстКода, НомерСтроки);
...
Функция ИзвлечьНомерСтрокиИзМаркера(СтрокаКода) Экспорт
	...
	Возврат конс_Инлайнер.ИзвлечьНомерСтрокиИзМаркера(СтрокаКода);
